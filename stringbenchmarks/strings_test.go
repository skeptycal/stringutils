...
// results 2/25/21
/*
BenchmarkCount/Benchmark:_Count-8         	                 1354	        871427 ns/op	       0 B/op	       0 allocs/op
BenchmarkCount/Benchmark:_bytes.Count-8   	                 1376	        864954 ns/op	       0 B/op	       0 allocs/op
BenchmarkCount/Benchmark:_bytes.Index-8   	            319558675	         3.740 ns/op	       0 B/op	       0 allocs/op
BenchmarkCount/Benchmark:_bytes.LastIndex-8         	318098150	         3.748 ns/op	       0 B/op	       0 allocs/op
BenchmarkCount/Benchmark:_bytes.Compare-8           	160405746	         7.472 ns/op	       0 B/op	       0 allocs/op
BenchmarkCount/Benchmark:_Equal-8                   	304546993	         3.904 ns/op	       0 B/op	       0 allocs/op
BenchmarkCount/Benchmark:_Contains-8                	177397784	         6.762 ns/op	       0 B/op	       0 allocs/op
*/
...
func BenchmarkCount(b *testing.B) {
	...
	for _, bb := range tests {
		...
		// b.Run(name, func(b *testing.B) {
		// 	for i := 0; i < b.N; i++ {
		// 		for b := range ByteSamples() {
		// 			bytes.Split(ByteSamples(), []byte{byte(b)})
		// 		}
		// 	}
		// })
	}
